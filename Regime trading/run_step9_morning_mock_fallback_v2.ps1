...
$RealPriceDb = Join-Path $ProjectRoot "data\source\market\step9i_shadow_intraday_prices.db"
...
'@
    ...
    if (-not [bool]$State.step9i.sealed) {
        Invoke-MockStage -Stage "step9i" -Arguments @(
            ...
            "--ledger-db", "data\ledgers\prospective\step9i_v2_shadow_ledger.db"
        )
    }
    if (-not [bool]$State.step9l.sealed) {
        Invoke-MockStage -Stage "step9l" -Arguments @(
            ...
            "--allow-late-reconstruction",
            "--source-db", $MockSnapshot0940Rel,
            "--ledger-db", "data\ledgers\prospective\step9l_v3_selected_strategy_shadow_ledger.db"
        )
    }
    $State = Get-MockStatus
    ...
    if (-not [bool]$State.step9s.sealed) {
        Invoke-MockStage -Stage "step9s" -Arguments @(
            ...
            "--allow-late-reconstruction",
            "--source-db", $MockSnapshot0940Rel,
            "--step9l-ledger-db", "data\ledgers\prospective\step9l_v3_selected_strategy_shadow_ledger.db",
    ...
    if (-not [bool]$State.step9r.sealed) {
        Invoke-MockStage -Stage "step9r" -Arguments @(
            ...
            "--source-db", $MockSnapshot0940Rel,
            "--step9l-ledger-db", "data\ledgers\prospective\step9l_v3_selected_strategy_shadow_ledger.db",
            "--research-db", "data\ledgers\research\step9r_candidate_ranking_research_v1.db",
            "--ledger-db", "data\ledgers\prospective\step9r_prospective_selector_shadow_v1.db"
        )
    }
    ...
    Invoke-NativeChecked `
        ...
        -Arguments @(
            ...
            "--date", $Date,
            "--step9i-ledger-db", "data\ledgers\prospective\step9i_v2_shadow_ledger.db",
            "--step9l-ledger-db", "data\ledgers\prospective\step9l_v3_selected_strategy_shadow_ledger.db",
